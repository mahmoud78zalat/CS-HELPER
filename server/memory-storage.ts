  ...
  private initializeSampleData() {
    ...
    const sampleEmailTemplates: EmailTemplate[] = [
      ...
      },
      {
        ...
        subject: "Tech Support Needed: {issue_type}",
        content: "Hi IT Team,\n\nWe need technical assistance for customer {customer_name}. Issue: {issue_description}\n\nPlease prioritize this request.\n\nThanks,\nCustomer Service",
        category: "Technical",
        genre: "technical support",
        concernedTeam: "IT Support",
        warningNote: null,
        variables: ["issue_type", "customer_name", "issue_description"],
        stageOrder: 2,
        isActive: true,
        usageCount: 0,
        createdBy: "admin-user",
